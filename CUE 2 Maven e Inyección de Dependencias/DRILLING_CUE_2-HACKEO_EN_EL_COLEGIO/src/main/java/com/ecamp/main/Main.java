package com.ecamp.main;

import java.util.ArrayList;
import java.util.Arrays;

import com.ecamp.model.Alumno;
import com.ecamp.model.Profesor;
import com.ecamp.service.Implementacion1;
import com.ecamp.service.Implementacion2;
import com.ecamp.service.Implementacion3;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Implementacion1 imple= new Implementacion1(alumnos);
		Implementacion2 imple2= new Implementacion2(alumnos);
		Implementacion3 imple3= new Implementacion3(alumnos);
		
		Profesor calcularPromedios = new Profesor(imple);
		Profesor calcularPromedios2 = new Profesor(imple2);
		Profesor calcularPromedios3 = new Profesor(imple3);
		
		
		calcularPromedios.calcular();
		calcularPromedios2.calcular();
		calcularPromedios3.calcular();
